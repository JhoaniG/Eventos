...
function UserCard({ usuario }) {
    ...
    // URLs de referencia
    const playerImage = playerPlaceholder // Imagen de jugador genérica
    const flagImage = 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Flag_of_Colombia.svg/960px-Flag_of_Colombia.svg.png'
        ...
        <div className="fut-card-wrapper">
            <div className="fut-card-base">
                ...
                <div className="fut-top">
                    ...
                    <img src={playerImage} alt={nombreCompleto} className="fut-player-img" />
                </div>
